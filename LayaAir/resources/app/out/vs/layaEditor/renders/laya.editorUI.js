...
(function(window,document,Laya){
	...
	var Animation=laya.display.Animation,AutoBitmap$1=laya.ui.AutoBitmap,ColorFilter=laya.filters.ColorFilter;
	var Component$1=laya.ui.Component,Ease=laya.utils.Ease,EffectAnimation=laya.display.EffectAnimation,Event=laya.events.Event;
	var EventDispatcher=laya.events.EventDispatcher,FileManager=laya.ide.managers.FileManager,Font=laya.display.css.Font;
	var FontClip=laya.ui.FontClip,GraphicAnimation=laya.utils.GraphicAnimation,Graphics=laya.display.Graphics;
	var HTMLDivElement=laya.html.dom.HTMLDivElement,HTMLImage=laya.resource.HTMLImage,Handler=laya.utils.Handler;
	var HttpRequest=laya.net.HttpRequest,IDEAPIS=laya.ide.managers.IDEAPIS,Image$1=laya.ui.Image,Input=laya.display.Input;
	var Loader$1=laya.net.Loader,MathUtil=laya.maths.MathUtil,MovieClip=laya.ani.swf.MovieClip,Node=laya.display.Node;
	var Particle2D=laya.particle.Particle2D,Point=laya.maths.Point,Pool=laya.utils.Pool,Rectangle=laya.maths.Rectangle;
	var ResFileManager=laya.ide.managers.ResFileManager,Skeleton=laya.ani.bone.Skeleton,SoundNode=laya.media.SoundNode;
	var Sprite=laya.display.Sprite,Text$1=laya.display.Text,Texture=laya.resource.Texture,Tween=laya.utils.Tween;
	var URL=laya.net.URL,Utils=laya.utils.Utils;
	Laya.interface('laya.editorUI.ISelect');
	Laya.interface('laya.editorUI.graphic.IGraphic');
	/**
	*
	*/
	//class laya.editorUI.AddComp
	var AddComp=(function(){
		function AddComp(){}
		__class(AddComp,'laya.editorUI.AddComp');
		var __proto=AddComp.prototype;
	...
	*/
	...
	var UIConfig$1=(function(){
		function UIConfig(){};
		__class(UIConfig,'laya.editorUI.UIConfig',null,'UIConfig$1');
		UIConfig.resPath="";
		UIConfig.uiPath="";
	...
	*/
	//class laya.editorUI.AutoBitmap extends laya.ui.AutoBitmap
	var AutoBitmap=(function(_super){
		function AutoBitmap(){
			AutoBitmap.__super.call(this);
			this.autoCacheCmd=false;
		}
		...
		AutoBitmap.setCache=function(key,value){
			AutoBitmap$1.setCache(key,value);
		}

		AutoBitmap.getCache=function(key){
			return AutoBitmap$1.getCache(key);
		}
	...
	*精灵
	*/
	//class laya.editorUI.SpritePlayer extends laya.display.Sprite
	var SpritePlayer=(function(_super){
		function SpritePlayer(){
			this.pic=null;
			this._comXml=null;
			this._mMBounds=null;
			SpritePlayer.__super.call(this);
			if (!this.pic){
				this.pic=new Image$1();
				this.pic.skin=ResFileManager.getIDECompIconPath("SpriteHolder");
				if(!IDEAPIS.isPreview)
					this.addChild(this.pic);
			}
		}

		__class(SpritePlayer,'laya.editorUI.SpritePlayer',_super);
		var __proto=SpritePlayer.prototype;
		Laya.imps(__proto,{"laya.ui.IBox":true})
		__proto._childChanged=function(child){
			_super.prototype._childChanged.call(this,child);
			if (this.numChildren > 1&&this.pic)this.pic.visible=false;
		}
		...
		__proto._getBoundPointsM=function(ifRotate){
			...
			return _super.prototype._getBoundPointsM.call(this,ifRotate);
		}
		...
		__getset(0,__proto,'width',function(){
			if (this._width > 0)
				return this._width;
			return this.getSelfBounds().right;
		...
		__getset(0,__proto,'height',function(){
			if (this._height > 0)
				return this._height;
			return this.getSelfBounds().bottom;
	...
	*控制点
	*/
	//class laya.editorUI.graphic.ControlPoint extends laya.display.Sprite
	var ControlPoint=(function(_super){
		function ControlPoint(){
			this.startHandler=null;
			this.endHandler=null;
			this.dragingHandler=null;
			this.doubleHandler=null;
			ControlPoint.__super.call(this);
			this.graphics.drawCircle(5,5,5,"#ffffff","#ff0000",1);
			this.size(10,10);
			this.pivot(5,5);
			this.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this._endPointStartDrag,[this]);
			this.on(/*laya.events.Event.DRAG_END*/"dragend",this,this._endPointDragEnd,[this]);
			this.on(/*laya.events.Event.DRAG_MOVE*/"dragmove",this,this._endPointDraging,[this]);
			this.on(/*laya.events.Event.DOUBLE_CLICK*/"doubleclick",this,this._doubleClick,[this]);
		}

		__class(ControlPoint,'laya.editorUI.graphic.ControlPoint',_super);
		var __proto=ControlPoint.prototype;
		__proto._doubleClick=function(sp){
			if (this.doubleHandler){
				this.doubleHandler.runWith(sp);
			}
		}

		__proto._endPointStartDrag=function(sp,e){
			e.stopPropagation();
			if (this.startHandler){
				this.startHandler.runWith(sp);
			}
		}

		__proto._endPointDraging=function(sp){
			if (this.dragingHandler){
				this.dragingHandler.runWith(sp);
			}
		}

		__proto._endPointDragEnd=function(sp){
			if (this.endHandler){
				this.endHandler.runWith(sp);
			}
		}
		...
		ControlPoint.getControlPoint=function(start,end,draging,doubleHandler){
			var rst;
	...
	*矢量图基类
	*/
	//class laya.editorUI.graphic.GraphicBase extends laya.display.Sprite
	var GraphicBase=(function(_super){
		function GraphicBase(){
			this.fillColor=null;
			this.lineColor=null;
			this.lineWidth=1;
			this.disablePivot=true;
			GraphicBase.__super.call(this);
			this.mouseEnabled=true;
			this.on(/*laya.events.Event.ADDED*/"added",this,this.drawSelf);
		}

		__class(GraphicBase,'laya.editorUI.graphic.GraphicBase',_super);
		var __proto=GraphicBase.prototype;
		Laya.imps(__proto,{"laya.editorUI.graphic.IGraphic":true})
		__proto.drawSelf=function(){}
		__proto.addChild=function(node){
			return null;
		}

		__proto.myAddChild=function(node){
	...
	*地图格子编辑组件
	*/
	//class laya.editorUI.GridEditor extends laya.display.Sprite
	var GridEditor=(function(_super){
		function GridEditor(){
			this.disablePivot=true;
			this.enableDragSet=true;
			...
			this._selectLineLayer=null;
			this.isSelectState=false;
			GridEditor.__super.call(this);
			this._selectLineLayer=new Sprite();
			this.addChild(this._selectLineLayer);
			this.mouseEnabled=true;
			this.on(/*laya.events.Event.ADDED*/"added",this,this.drawSelf);
			this.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this.mouseDownH);
			if (!GridEditor.tipText){
				GridEditor.tipText=new Text();
				GridEditor.tipText.color="#ffffff";
				GridEditor.tipText.align="center";
			}
		}

		__class(GridEditor,'laya.editorUI.GridEditor',_super);
		var __proto=GridEditor.prototype;
		__proto.updateTipState=function(){
			this.off(/*laya.events.Event.MOUSE_MOVE*/"mousemove",this,this.myMouseMove);
			this.off(/*laya.events.Event.MOUSE_OUT*/"mouseout",this,this.myMouseOut);
			this.off(/*laya.events.Event.MOUSE_OVER*/"mouseover",this,this.myMouseOver);
			if (this._showPos && this.isSelectState){
				this.on(/*laya.events.Event.MOUSE_MOVE*/"mousemove",this,this.myMouseMove);
				this.on(/*laya.events.Event.MOUSE_OUT*/"mouseout",this,this.myMouseOut);
				this.on(/*laya.events.Event.MOUSE_OVER*/"mouseover",this,this.myMouseOver);
			}else {}
		}

		__proto.myMouseOver=function(){
			this.addChild(GridEditor.tipText);
		}

		__proto.myMouseOut=function(){
			GridEditor.tipText.removeSelf();
		}

		__proto.myMouseMove=function(){
			if (GridEditor.tipText && GridEditor.tipText.parent){
				var pos;
				pos=this.getMousePoint();
				GridEditor.tipText.pos(pos.x,pos.y+20);
				GridEditor.tipText.text="("+this.getGridIJ(pos.x,pos.y).toString()+")";
				}else {
				if (this.isSelectState && GridEditor.tipText){
					this.addChild(GridEditor.tipText);
				}
			}
		}
		...
		__proto.getPointsByStr=function(str){
			var pointArr;
			pointArr=str.split(",");
			var i=0,len=0;
			len=pointArr.length;
		...
		__proto.renderMe=function(){
			var dataO;
			dataO=this["comXml"];
			if (dataO && dataO.props){
				if (dataO.props["data"]){
					this.data=this.getPointsByStr(dataO.props["data"]);
				}
			}
			this.graphics.clear();
			this.size(this.gridWidth *this.countX,this.gridHeight *this.countY);
			var i=0,j=0;
			var tX=NaN;
			var tY=NaN;
			for (i=0;i <=this.countY;i++){
				tY=i *this.gridHeight;
				this.graphics.drawLine(0,tY,this.width,tY,this.lineColor,this.lineWidth);
			}
			for (i=0;i <=this.countX;i++){
				tX=i *this.gridWidth;
				this.graphics.drawLine(tX,0,tX,this.height,this.lineColor,this.lineWidth);
			}
			...
			var hasChange=false;
			for (i=len-3;i >=0;i-=3){
				if (this.data[i] < this.countX && this.data[i+1] < this.countY){
					p=this.getIJPos(this.data[i],this.data[i+1]);
					this.graphics.fillText(this.data[i+2]+"",p.x,p.y-5,null,this.textColor,"center");
					}else {
		...
		__proto.getIJPos=function(i,j){
			var p;
			p=GridEditor._ijPosPoint;
			p.x=i *this.gridWidth+0.5 *this.gridWidth;
			p.y=j *this.gridHeight+0.5 *this.gridHeight;
			return p;
		}

		__proto.mouseDownH=function(){
			if (!this.isSelectState)return;
			GridEditor._preMousePos.setTo(Laya.stage.mouseX,Laya.stage.mouseY);
			GridEditor._preMyPos.setTo(this.mouseX,this.mouseY);
			this._isDragSelect=false;
		...
		__proto.onStageMouseMove=function(e){
			if (!this.isSelectState)return;
			if (!this.enableDragSet)return;
			if (this._isDragSelect){
				this._selectLineLayer.graphics.clear();
				this._selectLineLayer.graphics.drawRect(GridEditor._preMyPos.x,GridEditor._preMyPos.y,this.mouseX-GridEditor._preMyPos.x,this.mouseY-GridEditor._preMyPos.y,null,"#ff0000");
				}else {
				if (Math.abs(GridEditor._preMousePos.x-Laya.stage.mouseX)+Math.abs(GridEditor._preMousePos.y-Laya.stage.mouseY)> 5){
		...
		__proto.multiSelect=function(){
			...
			iLen=iLen < this.countY ? iLen :this.countY;
			jLen=jLen < this.countX ? jLen :this.countX;
			var index=0;
			var hasChange=false;
			for (i=range[1];i < iLen;i++){
				for (j=range[0];j < jLen;j++){
					this.changeGridValue(j,i,this.value,true,this.isCleanMode);
					hasChange=true;
				}
			}
			if (hasChange)
		...
		__proto.click=function(){
			if (!this.isSelectState)return;
			if (Math.abs(GridEditor._preMousePos.x-Laya.stage.mouseX)+Math.abs(GridEditor._preMousePos.y-Laya.stage.mouseY)> 5)return;
			var p;
			p=this.getGridIJ(this.mouseX,this.mouseY);
			console.log(p.toString());
			this.changeGridValue(p.x,p.y,this.value);
			this.noticeChange();
		}
		...
		__proto.noticeChange=function(){
			...
			dataO=this["comXml"];
			if (dataO && dataO.props){
				dataO.props["data"]=this.data.join(",");
				IDEAPIS.nodeChange(dataO,["data"],false);
			}
			this.renderMe();
		}

		__proto.changeGridValue=function(i,j,value,force,isClean){
			...
			for (ii=0;ii < len;ii+=3){
				if (this.data[ii]==i && this.data[ii+1]==j){
					if (!force){
						if (this.data[ii+2]==value){
							this.data.splice(ii,3);
							return;
						}
						}else {
						if (isClean){
			...
			this.data.push(i,j,value);
		}

		__proto.getWrapGrid=function(x,y,width,height){
			var rst;
			rst=[];
			rst.length=4;
			var tP;
		...
		__proto.getGridIJ=function(x,y){
			x-=GridEditor._wordSpace.x;
			y-=GridEditor._wordSpace.y;
			var i=0;
			i=Math.floor(x / this.gridWidth);
			var j=0;
			j=Math.floor(y / this.gridHeight);
			if (i < 0)i=0;
			if (j < 0)j=0;
			GridEditor._gridIJ.setTo(i,j);
			return GridEditor._gridIJ;
		}

		__proto.freshIDESelect=function(){}
		...
		__getset(0,__proto,'showPos',null,function(v){
			this._showPos=v;
			this.updateTipState();
		});

		__getset(0,__proto,'disableDragMove',function(){
			return this.enableDragSet;
		});

		GridEditor.DataSign="data";
		GridEditor.tipText=null
		__static(GridEditor,
		['_wordSpace',function(){return this._wordSpace=new Point(0,0);},'_ijPosPoint',function(){return this._ijPosPoint=new Point();},'_preMousePos',function(){return this._preMousePos=new Point();},'_preMyPos',function(){return this._preMyPos=new Point();},'_gridIJ',function(){return this._gridIJ=new Point();}
		]);
		return GridEditor;
	})(Sprite)
	...
	*/
	//class laya.editorUI.Component extends laya.ui.Component
	var Component=(function(_super){
		...
		__proto._getBoundPointsM=function(ifRotate){
			...
			if (this._width > 0 && this._height > 0){
				...
				this._mMBounds.setTo(0,0,this.width,this.height);
				return this._mMBounds._getBoundPoints();
			}
		...
		__proto.resetLayoutX=function(){
			...
			_super.prototype.resetLayoutX.call(this);
		}

		__proto.resetLayoutY=function(){
			if (this.disableLayout)return;
			_super.prototype.resetLayoutY.call(this);
		}
	...
	*@author ww
	*/
	//class laya.editorUI.DataSource extends laya.editorUI.SpritePlayer
	var DataSource=(function(_super){
		function DataSource(){
			DataSource.__super.call(this);
			this.pic.skin=ResFileManager.getIDECompIconPath("DataBase");
		}

		__class(DataSource,'laya.editorUI.DataSource',_super);
		return DataSource;
	})(SpritePlayer)
	...
	*画圆
	*/
	//class laya.editorUI.graphic.DrawCircle extends laya.editorUI.graphic.GraphicBase
	var DrawCircle=(function(_super){
		function DrawCircle(){
			this.radius=NaN;
			this._endPoint=null;
			DrawCircle.__super.call(this);
			this._initDragPoints();
		}

		__class(DrawCircle,'laya.editorUI.graphic.DrawCircle',_super);
		var __proto=DrawCircle.prototype;
		__proto._initDragPoints=function(){
			this._endPoint=new Sprite();
			this._endPoint.graphics.drawCircle(5,5,5,"#ffffff","#ff0000",1);
			this._endPoint.size(10,10);
			this._endPoint.pivot(5,5);
			this._endPoint.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this._endPointStargDrag);
			this._endPoint.on(/*laya.events.Event.DRAG_END*/"dragend",this,this._endPointDragEnd);
			this._endPoint.on(/*laya.events.Event.DRAG_MOVE*/"dragmove",this,this._endPointDraging);
		}

		__proto.drawSelf=function(){
			this.graphics.clear();
			this.graphics.drawCircle(0,0,this.radius,this.fillColor,this.lineColor,this.lineWidth);
			this.size(this.radius,this.radius);
		}

		__proto._endPointStargDrag=function(e){
			e.stopPropagation();
			this._endPoint.startDrag();
		}

		__proto._endPointDraging=function(){
			this.updateTos();
		}

		__proto._endPointDragEnd=function(){
			this.updateTos();
			var data;
			data=this["comXml"];
			if (data && data.props){
				data.props.radius=Math.round(this.radius);
				IDEAPIS.nodeChange(data,["radius"],false);
			}
		}

		__proto.updateTos=function(){
			this.radius=Math.sqrt(this._endPoint.x *this._endPoint.x+this._endPoint.y *this._endPoint.y);
			this.drawSelf();
		}
		...
		__proto.setIDESelectState=function(isSelect){
			if (isSelect){
				this.myAddChild(this._endPoint);
				this._endPoint.pos(this.radius,0);
				}else {
				this._endPoint.removeSelf();
			}
		}
	...
	*绘制线段
	*/
	//class laya.editorUI.graphic.DrawLines extends laya.editorUI.graphic.GraphicBase
	var DrawLines=(function(_super){
		function DrawLines(){
			this.points=null;
			this.pointList=null;
			this.isSelectState=false;
			...
			DrawLines.__super.call(this);
			this.on(/*laya.events.Event.DISPLAY*/"display",this,this._displayChange);
			this.on(/*laya.events.Event.UNDISPLAY*/"undisplay",this,this._displayChange);
			this.off(/*laya.events.Event.ADDED*/"added",this,this.drawSelf);
			this._start=new Handler(this,this._endPointStartDrag);
			this._end=new Handler(this,this._endPointDragEnd);
			this._draging=new Handler(this,this._endPointDraging);
			this._doubleClick=new Handler(this,this.onDoubleClick);
			this.mouseThrough=true;
		}

		__class(DrawLines,'laya.editorUI.graphic.DrawLines',_super);
		var __proto=DrawLines.prototype;
		__proto.onDoubleClick=function(sp){
			if (!this.isSelectState)return;
			var i=0,len=0;
			len=this.pointSpList.length;
			for (i=0;i < len;i++){
				if (this.pointSpList[i]==sp){
					(sp).recover();
					this.pointSpList.splice(i,1);
					this._updateAndChangeValue();
					return;
				}
			}
		}

		__proto._displayChange=function(){
			this.off(/*laya.events.Event.DOUBLE_CLICK*/"doubleclick",this,this._mMouseDown);
			this.on(/*laya.events.Event.DOUBLE_CLICK*/"doubleclick",this,this._mMouseDown);
			this.drawSelf();
		}

		__proto.getDistance=function(sp0,sp1){
			var dx=sp1.x-sp0.x;
			var dy=sp1.y-sp0.y;
			return Math.sqrt(dx *dx+dy *dy);
		}

		__proto._mMouseDown=function(e){
			if (!this.isSelectState)return;
			if ((e.target instanceof laya.editorUI.graphic.ControlPoint ))return;
			var nCt;
			nCt=this._getAControlPoint();
			nCt.pos(this.mouseX,this.mouseY);
			if (this.getDistance(this.pointSpList[0],nCt)< this.getDistance(this.pointSpList[this.pointSpList.length-1],nCt)){
				this.pointSpList.unshift(nCt);
				}else{
				this.pointSpList.push(nCt);
			}
			this._updateAndChangeValue();
		}
		...
		__proto.getPointsArrBySpList=function(spList){
			var i=0,len=0;
			len=spList.length;
			var rst;
			rst=[];
		...
		__proto.drawSelf=function(){
			...
			this.pointList=this.getPointsByStr(this.points);
			this.drawWork();
			var rec;
			rec=this.graphics.getBounds();
			this.size(rec.right,rec.bottom);
			if (this.isSelectState && this.displayedInStage){
				var i=0,len=0;
				var tsp;
				len=this.pointList.length;
				for (i=0;i < len;i+=2){
					tsp=this._getAControlPoint();
					tsp.pos(this.pointList[i],this.pointList[i+1]);
					this.myAddChild(tsp);
					this.pointSpList.push(tsp);
				}
			}
		}

		__proto._getAControlPoint=function(){
			return ControlPoint.getControlPoint(this._start,this._end,this._draging,this._doubleClick);
		}

		__proto.drawWork=function(){
			this.graphics.drawLines(0,0,this.pointList,this.lineColor,this.lineWidth);
		}

		__proto._endPointStartDrag=function(sp){
			sp.startDrag();
		}
		...
		__proto._endPointDraging=function(sp){
			...
			var tSp;
			for (i=0;i < len;i++){
				tSp=this.pointSpList[i];
				this.pointList[i *2]=tSp.x;
				this.pointList[i *2+1]=tSp.y;
			}
			this.graphics.clear();
			this.drawWork();
		}
		...
		__proto._updateAndChangeValue=function(){
			this.updateTos();
			var data;
			data=this["comXml"];
			if (data && data.props){
				data.props.points=this.points;
				IDEAPIS.nodeChange(data,["points"],false);
			}
		}

		__proto.updateTos=function(){
			this.points=this.getPointsArrBySpList(this.pointSpList).join(",");
			this.drawSelf();
		}

		__proto.removePoints=function(){
			var i=0,len=0;
			len=this.pointSpList.length;
			var tsp;
			for (i=0;i < len;i++){
	...
	*画线
	*/
	//class laya.editorUI.graphic.DrawLine extends laya.editorUI.graphic.GraphicBase
	var DrawLine=(function(_super){
		function DrawLine(){
			this.toX=0;
			this.toY=0;
			this._endPoint=null;
			DrawLine.__super.call(this);
			this._endPoint=new Sprite();
			this._endPoint.graphics.drawCircle(5,5,5,"#ffffff","#ff0000",1);
			this._endPoint.size(10,10);
			this._endPoint.pivot(5,5);
		...
		__class(DrawLine,'laya.editorUI.graphic.DrawLine',_super);
		var __proto=DrawLine.prototype;
		__proto._endPointStargDrag=function(e){
			e.stopPropagation();
			this._endPoint.startDrag();
		}
		...
		__proto._endPointDragEnd=function(){
			...
			data=this["comXml"];
			if (data && data.props){
				data.props.toX=this.toX;
				data.props.toY=this.toY;
				IDEAPIS.nodeChange(data,["toX","toY"],false);
			}
		}

		__proto.updateTos=function(){
			this.toX=this._endPoint.x;
			this.toY=this._endPoint.y;
			this.drawSelf();
		}

		__proto.drawSelf=function(){
			this.graphics.clear();
			this.graphics.drawLine(0,0,this.toX,this.toY,this.lineColor,this.lineWidth);
			var rec;
			var w=NaN;
			var h=NaN;
			w=Math.abs(this.toX)> 0 ? Math.abs(this.toX):2;
			h=Math.abs(this.toY)> 0 ? Math.abs(this.toY):2;
			this.size(w,h);
			this._endPoint.pos(this.toX,this.toY);
		}
	...
	*绘制扇形
	*/
	//class laya.editorUI.graphic.DrawPie extends laya.editorUI.graphic.GraphicBase
	var DrawPie=(function(_super){
		function DrawPie(){
			this.radius=NaN;
			this.startAngle=NaN;
			this.endAngle=NaN;
			this._tDragPoint=null;
			this._startPoint=null;
			this._endPoint=null;
			DrawPie.__super.call(this);
			this._initDragPoints();
		}

		__class(DrawPie,'laya.editorUI.graphic.DrawPie',_super);
		var __proto=DrawPie.prototype;
		__proto.drawSelf=function(){
			this.graphics.clear();
			this.graphics.drawPie(0,0,this.radius,this.startAngle,this.endAngle,this.fillColor,this.lineColor,this.lineWidth);
			this.size(this.radius,this.radius);
			if (this._tDragPoint !=this._startPoint){
				this._posSprite(this.startAngle,this._startPoint);
			}
			if (this._tDragPoint !=this._endPoint){
				this._posSprite(this.endAngle,this._endPoint);
			}
		}

		__proto._posSprite=function(angle,sp){
			var r=NaN;
			r=angle *Math.PI / 180;
			sp.pos(this.radius *Math.cos(r),this.radius *Math.sin(r));
		}

		__proto._initDragPoints=function(){
			this._startPoint=this.createDragPoint();
			this._endPoint=this.createDragPoint();
		}

		__proto.createDragPoint=function(){
			var _rstPoint;
			_rstPoint=new Sprite();
			_rstPoint.graphics.drawCircle(5,5,5,"#ffffff","#ff0000",1);
			_rstPoint.size(10,10);
			_rstPoint.pivot(5,5);
			_rstPoint.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this._endPointStargDrag,[_rstPoint]);
			_rstPoint.on(/*laya.events.Event.DRAG_END*/"dragend",this,this._endPointDragEnd,[_rstPoint]);
			_rstPoint.on(/*laya.events.Event.DRAG_MOVE*/"dragmove",this,this._endPointDraging,[_rstPoint]);
			return _rstPoint;
		}

		__proto._endPointStargDrag=function(sp,e){
			e.stopPropagation();
			this._tDragPoint=sp;
			sp.startDrag();
		}
		...
		__proto._endPointDragEnd=function(){
			...
			data=this["comXml"];
			if (data && data.props){
				data.props.radius=this.radius;
				data.props.startAngle=this.startAngle;
				data.props.endAngle=this.endAngle;
				IDEAPIS.nodeChange(data,["radius","startAngle","endAngle"],false);
			}
		}

		__proto.updateTos=function(){
			switch (this._tDragPoint){
				case this._startPoint:
					this.startAngle=MathUtil.getRotation(0,0,this._startPoint.x,this._startPoint.y);
					this.radius=Math.sqrt(this._startPoint.x *this._startPoint.x+this._startPoint.y *this._startPoint.y);
					break ;
				case this._endPoint:
					this.endAngle=MathUtil.getRotation(0,0,this._endPoint.x,this._endPoint.y);
					this.radius=Math.sqrt(this._endPoint.x *this._endPoint.x+this._endPoint.y *this._endPoint.y);
					break ;
				}
			this.drawSelf();
		...
		__proto.setIDESelectState=function(isSelect){
			if (isSelect){
				this.myAddChild(this._startPoint);
				this.myAddChild(this._endPoint);
				}else {
				this._startPoint.removeSelf();
				this._endPoint.removeSelf();
			}
		}
	...
	*绘制矩形
	*/
	//class laya.editorUI.graphic.DrawRect extends laya.editorUI.graphic.GraphicBase
	var DrawRect=(function(_super){
		function DrawRect(){DrawRect.__super.call(this);;
		};

		__class(DrawRect,'laya.editorUI.graphic.DrawRect',_super);
		var __proto=DrawRect.prototype;
		Laya.imps(__proto,{"laya.editorUI.graphic.IGraphic":true})
		__proto.drawSelf=function(){
			this.graphics.clear();
			this.graphics.drawRect(0,0,this.width,this.height,this.fillColor,this.lineColor,this.lineWidth);
			this.size(this.width,this.height);
		}

		__getset(0,__proto,'width',_super.prototype._$get_width,function(value){
			if (this.width !=value){
				Laya.timer.once(10,this,this.drawSelf);
			}
	...
	*绘制位图
	*/
	//class laya.editorUI.graphic.DrawTexture extends laya.editorUI.graphic.GraphicBase
	var DrawTexture=(function(_super){
		function DrawTexture(){
			this._skin=null;
			DrawTexture.__super.call(this);
		}

		__class(DrawTexture,'laya.editorUI.graphic.DrawTexture',_super);
		var __proto=DrawTexture.prototype;
		__proto.drawSelf=function(){
			this.graphics.clear();
			var tex;
			tex=Loader.getRes(this.skin);
			if (tex){
				this.graphics.drawTexture(tex,0,0,this._width,this._height);
				var rec;
				rec=this.graphics.getBounds();
			}
		}
	...
	*绘制文本
	*/
	//class laya.editorUI.graphic.FillText extends laya.editorUI.graphic.GraphicBase
	var FillText=(function(_super){
		function FillText(){
			this.text=null;
			this.font=null;
			this.color=null;
			this.textAlign=null;
			this._mMBounds=null;
			FillText.__super.call(this);
			this.size(100,100);
		}

		__class(FillText,'laya.editorUI.graphic.FillText',_super);
		var __proto=FillText.prototype;
		__proto.drawSelf=function(){
			this.graphics.clear();
			this.graphics.fillText(this.text,0,0,this.font,this.color,this.textAlign);
		}
	...
	*脚本
	*/
	//class laya.editorUI.Script extends laya.editorUI.SpritePlayer
	var Script=(function(_super){
		function Script(){
			Script.__super.call(this);
		}

		__class(Script,'laya.editorUI.Script',_super);
		return Script;
	})(SpritePlayer)
	...
	*Flash时间轴动画播放器
	*/
	//class laya.editorUI.MovieClipPlayer extends laya.ani.swf.MovieClip
	var MovieClipPlayer=(function(_super){
		function MovieClipPlayer(){
			this._comXml=null;
			this._mMBounds=null;
			MovieClipPlayer.__super.call(this);
			this.size(100,100);
			this.setBounds(new Rectangle(0,0,100,100));
		}

		__class(MovieClipPlayer,'laya.editorUI.MovieClipPlayer',_super);
		var __proto=MovieClipPlayer.prototype;
		Laya.imps(__proto,{"laya.ui.IComponent":true})
		__proto._getBoundPointsM=function(ifRotate){
			(ifRotate===void 0)&& (ifRotate=false);
			if (this._width > 0 && this._height > 0 && !this.autoSize){
	...
	*例子播放器
	*/
	//class laya.editorUI.ParticlePlayer extends laya.particle.Particle2D
	var ParticlePlayer=(function(_super){
		...
		__proto.setParticleSetting=function(settings){
			...
			_super.prototype.setParticleSetting.call(this,settings);
		}

		__proto.setIDEFocusState=function(focus){
			this._focus=focus;
		}
	...
	*声音播放器
	*/
	//class laya.editorUI.SoundPlayer extends laya.media.SoundNode
	var SoundPlayer=(function(_super){
		function SoundPlayer(){
			this.img=null;
			SoundPlayer.__super.call(this);
			this.visible=true;
		...
		__class(SoundPlayer,'laya.editorUI.SoundPlayer',_super);
		var __proto=SoundPlayer.prototype;
	...
	*/
	...
	var Text=(function(_super){
		...
		__class(Text,'laya.editorUI.Text',_super);
		return Text;
	})(Text$1)
	...
	*动画播放器
	*/
	//class laya.editorUI.AnimationPlayer extends laya.display.Animation
	var AnimationPlayer=(function(_super){
		...
		__class(AnimationPlayer,'laya.editorUI.AnimationPlayer',_super);
	...
	*/
	...
	var Box=(function(_super){
		function Box(){
			...
			this.callLater(this.checkIfShowRec);
		}
		...
		__proto._childChanged=function(child){
			laya.display.Sprite.prototype._childChanged.call(this,child);
			this.callLater(this.checkIfShowRec);
		}

		__proto.checkIfShowRec=function(){
			if (IDEAPIS.isPreview)return;
			this.graphics.clear();
			if (this.numChildren<1){
				this.graphics.drawRect(0,0,this.width?this.width:100,this.height?this.height:100,null,"#666666");
			}
		}
	...
	var Clip=(function(_super){
		...
		*/
		__proto.destroy=function(clearFromCache){
			...
			laya.ui.Component.prototype.destroy.call(this,true);
			this._bitmap && this._bitmap.destroy();
			this._bitmap=null;
			this._sources=null;
		}
		...
		*/
		__proto._onDisplay=function(e){
			if (this._isPlaying){
				if (this.displayedInStage)this.play();
				else this.stop();
				}else if (this._autoPlay && this.displayedInStage){
				this.play();
			}
		}
	...
	*/
	...
	var Image=(function(_super){
		function Image(skin){
			...
			this.rec=new Sprite();
			this.skin=skin;
			this.on(/*laya.events.Event.ADDED*/"added",this,this._addedToParent);
			this.callLater(this.checkIfShowRec);
		}

		__class(Image,'laya.editorUI.Image',_super);
		var __proto=Image.prototype;
		__proto._addedToParent=function(){
			if ((this.parent instanceof laya.editorUI.GraphicContainer )){
				this.removeChildren();
				}else{
			}
		}
		...
		__proto.checkIfShowRec=function(){
			...
			this.rec.removeSelf();
			if (!this.skin){
				this.rec.graphics.drawRect(0,0,this.width?this.width:50,this.height?this.height:50,null,"#666666");
	...
	*/
	...
	var ScrollBar=(function(_super){
		function ScrollBar(skin){
			...
			this._offsets=null;
			this._touchScrollEnable=true;
			this._mouseWheelEnable=true;
	...
	var Slider=(function(_super){
		...
		*/
		...
		__proto.initialize=function(){
			...
			this._progress.sizeGrid=this._bg.sizeGrid=this._bar.sizeGrid="4,4,4,4,0";
		...
		*/
		__getset(0,__proto,'skin',function(){
			...
			if (this._skin !=value){
				...
				var _progressSkin=this._skin.replace(".png","$progress.png");
				if (ResFileManager.hasRes(_progressSkin)){
					this._progress.skin=_progressSkin;
					if (!this._progress.parent){
	...
	*/
	...
	var Label=(function(_super){
		...
		__proto.checkIfShowRec=function(){
			...
			this.graphics.clear();
			if (!this.text){
				this.graphics.drawRect(0,0,this.width?this.width:100,this.height?this.height:22,null,"#666666");
			}
		}
		...
		*/
		...
		Label.initDefaultFontInfo=function(fontInfo){
			Label.labelDefaultFont="Arial";
			Label.labelDefaultSize=12;
			if (!fontInfo)return;
			var tArr;
			...
			if (tArr.length==2){
				...
				if (tSize > 0){
					Label.labelDefaultSize=tSize;
					Label.labelDefaultFont=tArr[1]["trim"]();
				}
			}
		}

		Label.labelDefaultFont=null
		Label.labelDefaultSize=12;
		return Label;
	})(Component)
	...
	*画曲线
	*/
	//class laya.editorUI.graphic.DrawCurves extends laya.editorUI.graphic.DrawLines
	var DrawCurves=(function(_super){
		function DrawCurves(){
			DrawCurves.__super.call(this);
		}

		__class(DrawCurves,'laya.editorUI.graphic.DrawCurves',_super);
		var __proto=DrawCurves.prototype;
		__proto.drawWork=function(){
			this.graphics.drawCurves(0,0,this.pointList,this.lineColor,this.lineWidth);
		}
	...
	*绘制多边形
	*/
	//class laya.editorUI.graphic.DrawPoly extends laya.editorUI.graphic.DrawLines
	var DrawPoly=(function(_super){
		function DrawPoly(){
			DrawPoly.__super.call(this);
		}

		__class(DrawPoly,'laya.editorUI.graphic.DrawPoly',_super);
		var __proto=DrawPoly.prototype;
		__proto.drawWork=function(){
			this.graphics.drawPoly(0,0,this.pointList,this.fillColor,this.lineColor,this.lineWidth);
		}
	...
	*填充位图
	*/
	//class laya.editorUI.graphic.FillTexture extends laya.editorUI.graphic.DrawTexture
	var FillTexture=(function(_super){
		function FillTexture(){
			this._repeat=null;
			FillTexture.__super.call(this);
			this.autoSize=false;
		}

		__class(FillTexture,'laya.editorUI.graphic.FillTexture',_super);
		var __proto=FillTexture.prototype;
		__proto.drawSelf=function(){
			this.graphics.clear();
			var tex;
			tex=Loader.getRes(this.skin);
			if (tex){
				this.graphics.fillTexture(tex,0,0,this.width,this.height,this.repeat);
				var rec;
				rec=this.graphics.getBounds();
				this.size(rec.width,rec.height);
			}
		}
	...
	*/
	...
	var HtmlText=(function(_super){
		function HtmlText(){
			...
			this.URI=new URL(ResFileManager.adptToCommonUrl(ResFileManager.basePath)+"/");
		}

		__class(HtmlText,'laya.editorUI.HtmlText',_super);
		var __proto=HtmlText.prototype;
		Laya.imps(__proto,{"laya.ui.IComponent":true})
		/**
		*@private
		*@inheritDoc
	...
	*@author ww
	*/
	//class laya.editorUI.EffectAnimationPlayer extends laya.display.EffectAnimation
	var EffectAnimationPlayer=(function(_super){
		function EffectAnimationPlayer(){
			this.img=null;
			EffectAnimationPlayer.__super.call(this);
			this.visible=true;
			this.img=new Image$1();
			this.addChild(this.img);
			this.autoSize=true;
		...
		__class(EffectAnimationPlayer,'laya.editorUI.EffectAnimationPlayer',_super);
		var __proto=EffectAnimationPlayer.prototype;
		__getset(0,__proto,'skin',null,function(path){
			this.img.skin=path;
		});

		return EffectAnimationPlayer;
	})(EffectAnimation)
	...
	*Graphics容器
	*/
	//class laya.editorUI.GraphicContainer extends laya.editorUI.Box
	var GraphicContainer=(function(_super){
		function GraphicContainer(){
			this.pic=null;
			GraphicContainer.__super.call(this);
			this.on(/*laya.events.Event.ADDED*/"added",this,this.onAddToParent);
		}

		__class(GraphicContainer,'laya.editorUI.GraphicContainer',_super);
		var __proto=GraphicContainer.prototype;
		__proto.onAddToParent=function(){
			if (this.parent){
				if (this.numChildren < 1){
					if (!this.pic){
						this.pic=new Image();
						this.pic.skin="spriteSkin.png";
						this.pic.size(100,100);
						laya.display.Node.prototype.addChild.call(this,this.pic);
					}
				}
			}
		}
		...
		__proto.removeChild=function(node){
			if (node !=this.pic && this.numChildren==1){
				this.pic=new Image();
				this.pic.skin="spriteSkin.png";
				this.pic.size(100,100);
				laya.display.Node.prototype.addChild.call(this,this.pic);
		...
		__proto.addChild=function(node){
			if ((node instanceof laya.editorUI.Image )|| (node instanceof laya.editorUI.graphic.GraphicBase )){
				if (this.pic){
					this.pic.removeSelf();
				}
				return laya.display.Node.prototype.addChild.call(this,node);
	...
	*@author ww
	*/
	//class laya.editorUI.FontClipPlayer extends laya.ui.FontClip
	var FontClipPlayer=(function(_super){
		function FontClipPlayer(skin,sheet){
			FontClipPlayer.__super.call(this,skin,sheet);
		}

		__class(FontClipPlayer,'laya.editorUI.FontClipPlayer',_super);
		var __proto=FontClipPlayer.prototype;
		__proto.changeClip=function(){
	...
	var List=(function(_super){
		...
		*/
		...
		__proto._createItems=function(startY,numX,numY){
			...
			for (var k=startY;k < numY;k++){
				for (var l=0;l < numX;l++){
					...
					cell.x=(this._isVertical ? l :k)*cellWidth-box.x+this._offset.x;
					cell.y=(this._isVertical ? k :l)*cellHeight-box.y+this._offset.y;
		...
		__proto.createItem=function(){
			var rst;
			rst=(typeof this._itemRender=='function')? new this._itemRender():View.createComp(this._itemRender);
			return rst;
		}
		...
		*/
		__proto.onScrollBarChange=function(e){
			...
			var scrollLine=Math.floor((scrollValue+this._offset.y *2)/ this._cellSize);
			if (!this.cacheContent){
		...
		*/
		...
		__getset(0,__proto,'cacheContent',function(){
			return false;
			},function(value){
	...
	*/
	...
	var Panel=(function(_super){
		...
		*/
		...
		__getset(0,__proto,'comXml',function(){
			return _super.prototype._$get_comXml.call(this);
			},function(value){
			_super.prototype._$set_comXml.call(this,value);
			this.content["comXml"]=value;
		});
	...
	*Graphics解析器
	*/
	//class laya.editorUI.GraphicParser extends laya.utils.GraphicAnimation
	var GraphicParser=(function(_super){
		function GraphicParser(){GraphicParser.__super.call(this);;
		};

		__class(GraphicParser,'laya.editorUI.GraphicParser',_super);
		var __proto=GraphicParser.prototype;
		__proto._getTextureByUrl=function(url){
			return Loader.getRes(url);
		}

		GraphicParser.parseAnimationByData=function(animationObject){
			if (!GraphicParser._I)
				GraphicParser._I=new GraphicParser();
			var rst;
			rst=GraphicParser._I.parseByData(animationObject);
			GraphicParser._I._clear();
			return rst;
		}

		GraphicParser._I=null
		return GraphicParser;
	})(GraphicAnimation)
	...
	*Graphics位图
	*/
	//class laya.editorUI.GraphicPic extends laya.editorUI.Image
	var GraphicPic=(function(_super){
		function GraphicPic(){
			GraphicPic.__super.call(this);
		}

		__class(GraphicPic,'laya.editorUI.GraphicPic',_super);
		var __proto=GraphicPic.prototype;
		__proto.checkIfShowRec=function(){}
		return GraphicPic;
	})(Image)
	...
	*/
	...
	var TextInput=(function(_super){
		...
		__proto.createChildren=function(){
			...
			if (Label.labelDefaultFont){
				this._tf.font=Label.labelDefaultFont;
			}
			if (Label.labelDefaultSize){
				this._tf.fontSize=Label.labelDefaultSize;
			}
			...
			DialogManager=(function(_super){
				...
				*/
				__proto.onResize=function(e){
					...
					this.modalLayer.graphics.alpha(UIConfig$1.popupBgAlpha);
					this.modalLayer.graphics.drawRect(0,0,width,height,UIConfig$1.popupBgColor);
